<nav class="navbar navbar-expand-lg custom-navbar d-none d-lg-flex">
    <div class="container-1600 header-inner">
        ...
        <div class="d-flex flex-column" style="gap: 6px;">
            ...
            <a href="<?php echo e(route('contacts.index')); ?>" class="subtitle-link">
    <div class="subtitle-badge">
        ...
        <div class="navbar-nav-wrapper">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link d-inline-flex align-items-center gap-2 <?php echo e(request()->routeIs('main.index') ? 'active' : ''); ?>"
                       href="<?php echo e(route('main.index')); ?>">
                ...
                <li class="nav-item">
                    <a class="nav-link d-inline-flex align-items-center <?php echo e(request()->routeIs('shop.index') ? 'active' : ''); ?>" href="<?php echo e(route('shop.index')); ?>">
                        <i class="bi bi-grid-fill me-2"></i> Каталог товарів
                    </a>
                </li>

                <li class="nav-item">
                    <a class="nav-link d-inline-flex align-items-center gap-2 <?php echo e(request()->routeIs('about.index') ? 'active' : ''); ?>"
                ...
                <li class="nav-item">
                    <a class="nav-link d-inline-flex align-items-center gap-2 <?php echo e(request()->routeIs('contacts.index') ? 'active' : ''); ?>"
                ...
                <?php if(auth()->guard()->check()): ?>
                    <?php if(auth()->user()->isAdmin()): ?>
                        ...
                        <li class="nav-item">
                            <a class="nav-link d-inline-flex align-items-center gap-2 <?php echo e(request()->routeIs('admin.*') ? 'active' : ''); ?>"
        ...
        <div class="header-right">
            ...
            <div class="header-auth-buttons">
                ...
                <?php if(auth()->guard()->check()): ?>
                    ...
                    <?php if(auth()->user()->isAdmin()): ?>
                        <a href="<?php echo e(route('users.index')); ?>" class="login-btn admin-btn">
        ...
        <?php echo e(number_format($cartTotal, 0, '.', ' ')); ?>
                    ...
                    <?php echo e(auth()->user()->name); ?>
                        ...
                        <ul class="dropdown-menu dropdown-menu-end custom-dropdown">
                            ...
                            <li>
                                <a class="dropdown-item <?php echo e(request()->routeIs('dashboard') ? 'active-item' : ''); ?>"
                            ...
                            <li>
                                <a class="dropdown-item <?php echo e(request()->routeIs('profile.*') ? 'active-item' : ''); ?>"
...
<?php /**PATH /var/www/my_project/resources/views/partials/navbar.blade.php ENDPATH**/ ?>