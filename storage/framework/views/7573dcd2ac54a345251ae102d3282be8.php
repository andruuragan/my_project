...
<main class="py-5 bg-white">
    ...
    <a href="<?php echo e(route('main.index')); ?>" class="text-decoration-none text-muted small">Головна</a> / 
    <a href="<?php echo e(route('useful.index')); ?>" class="text-decoration-none text-muted small">Корисна інформація</a> /
    <a href="<?php echo e(route('chimney.installation-rules')); ?>" class="text-decoration-none text-muted small">Монтаж</a> / 
    <a href="<?php echo e(route('blog.installation-errors')); ?>" 
   class="text-decoration-none small <?php echo e(request()->routeIs('blog.installation-errors') ? 'active text-warning' : 'text-muted'); ?>">
   Блог
</a>
</nav>
        ...
        <img src="<?php echo e(asset('images/chimney/article-main.webp')); ?>" class="img-fluid rounded-4 mb-5 shadow" alt="Помилки монтажу">
   ...
   style="background-color: #d97706; border-color: #d97706; color: white;">
    <i class="bi bi-cart-fill me-2"></i> Купити надійний димохід
        ...
        <div class="p-5 mt-5 bg-dark text-white rounded-4 text-center">
            ...
            <a href="<?php echo e(route('chimney.installation-rules')); ?>#form" class="btn btn-warning px-4 py-2">Отримати консультацію</a>
        </div>
    </div>
</main>
<style>
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/my_project/resources/views/blog/installation-errors.blade.php ENDPATH**/ ?>