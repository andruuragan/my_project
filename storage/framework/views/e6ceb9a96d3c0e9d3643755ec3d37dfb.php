<?php $__env->startSection('content'); ?>
    <div class="container-1600 py-4">
        ...
        <!-- Кнопка повернення -->
        <div class="mb-4">
            <a href="<?php echo e(route('shop.index')); ?>" class="btn btn-sm btn-outline-secondary rounded-pill d-inline-flex align-items-center gap-1 shadow-sm">
        ...
        <div class="card shadow-sm border-0 bg-white rounded-3 overflow-hidden p-4 mb-4">
            <div class="row g-4">
                ...
                <div class="col-12 col-md-7 col-lg-8 d-flex flex-column justify-content-between ps-md-4">
                    <div>
                        <h2 class="fw-bold text-dark mb-3"><?php echo e($catalog->name); ?></h2>
        ...
        <span id="dynamic-total"><?php echo e(number_format($catalog->price, 0, '.', ' ')); ?></span>
        <small class="fs-5 fw-normal text-muted">грн</small>
    </span>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex flex-wrap align-items-center gap-3">
                                    <?php if(auth()->guard()->check()): ?>
                                        ...
                                        <div class="d-flex align-items-end" style="height: 46px; margin-top: auto;">
                                            <button type="button"
                                                    id="add-to-cart-<?php echo e($catalog->id); ?>"
                                                    ...
                                                    data-name="<?php echo e($catalog->name); ?>"
                                                    data-price="<?php echo e($catalog->price); ?>"
                                                    data-url="<?php echo e(route('cart.add', $catalog->id)); ?>">
                        ...
                        <div class="row row-cols-1 row-cols-sm-2 g-3">
                            <div class="col d-flex justify-content-between border-bottom pb-2">
                                ...
                                <span class="fw-medium text-dark"><?php echo e($catalog->type ?? '-'); ?></span>
                            </div>
                            <div class="col d-flex justify-content-between border-bottom pb-2">
                                <span class="text-muted">Товщина:</span>
                                <span class="fw-medium text-dark"><?php echo e($catalog->thickness ?? '-'); ?></span>
                            </div>
                            <div class="col d-flex justify-content-between border-bottom pb-2">
                                <span class="text-muted">Марка нерж. (AISI):</span>
                                <span class="fw-medium text-dark"><?php echo e($catalog->grade ?? '-'); ?></span>
                            </div>
                            <div class="col d-flex justify-content-between border-bottom pb-2">
                                <span class="text-muted">Діаметр:</span>
                                <span class="fw-medium text-dark"><?php echo e($catalog->diameter ?? '-'); ?></span>
                            </div>
                            <div class="col d-flex justify-content-between border-bottom pb-2">
                                <span class="text-muted">Тип димоходу:</span>
                                <span class="fw-medium text-dark"><?php echo e($catalog->chimneyType ?? '-'); ?></span>
                            </div>
                            <div class="col d-flex justify-content-between border-bottom pb-2">
                                <span class="text-muted">Кожух:</span>
                                <span class="fw-medium text-dark"><?php echo e($catalog->casing == 'н' ? '-' : $catalog->casing); ?></span>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/my_project/resources/views/catalog/public-show.blade.php ENDPATH**/ ?>