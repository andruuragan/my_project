...
<div class="container-1600 py-5">
    <div class="text-center mb-5">
        ...
        <div class="mx-auto bg-warning rounded mt-3" style="width:80px;height:5px;"></div>
         <h3 class="mb-3 mt-3 fw-bold">Зв'яжіться з нами</h3>

<p class="text-muted mb-4">
    Заповніть форму, і ми зв'яжемося з вами найближчим робочим часом.
</p>
    </div>
...
<p class="text-muted">
    DymSystems спеціалізується на виробництві та продажу димоходів із нержавіючої сталі
...
<p class="text-muted mb-0">
        ...
        <div class="col-lg-7 order-1 order-lg-2">
            <div class="card border-0 shadow-sm p-4 p-lg-5 mb-4">
                ...
                <form action="{{ route('contact.send') }}" method="POST">
                    ...
                    <div class="form-floating mb-3">
                        <input type="tel" name="phone" class="form-control phone-mask" id="phone" placeholder="+38 (___) ___-__-__" required>
  ...
  <button type="submit" class="btn btn-warning btn-lg w-100 fw-bold py-3 btn-shadow-hover">
    Відправити повідомлення
            ...
            <div class="card border-0 shadow-sm p-4">
               <h4 class="fw-bold mb-2">Поширені запитання</h4>
...
<p class="text-muted mb-4">
    Відповіді на найпоширеніші запитання наших клієнтів.
                ...
                <div class="accordion" id="faqAccordion">
                    @foreach([
                        ['q' => 'Як швидко ви відповідаєте?', 'a' => 'Зазвичай ми зв\'язуємося з клієнтами протягом робочого дня.'],
                        ['q' => 'Чи допомагаєте з підбором?', 'a' => 'Так, ми проводимо повний інженерний розрахунок під ваше обладнання.'],
                        ['q' => 'Доставка по Україні?', 'a' => 'Так, відправляємо Новою Поштою щодня.']
                    ] as $index => $item)
                        <div class="accordion-item border-0 border-bottom">
                            <h2 class="accordion-header">
                                <button class="accordion-button {{ $index !== 0 ? 'collapsed' : '' }} fw-bold shadow-none" type="button" data-bs-toggle="collapse" data-bs-target="#faq{{ $index }}">
                                    {{ $item['q'] }}
                                </button>
                            </h2>
