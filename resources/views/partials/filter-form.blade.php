 <form class="filter-form" id="mainFilterForm" method="GET" action="{{ route('shop.index') }}">
                        ...
                        @php
                            $types = [
                                ...
                                'Стіновий хомут', 'Монтажний хомут', 'Конус', 'Термоґрибok', 'Дека',
                                'Заглушка', 'Старт-сендвіч', 'Труба-подовжувач', 'Прохід', 'Відображувач', 'Труба овальна', 'Трійник овальний 90°', 'Трійник овальний 45°', 'Коліно овальне 45°', 'Коліно овальне 90°', 'Закінчення димоходу овальне', 'Перехід овальний', 'Грибок овальний', 'Лійка овальна', 'Скоба овальна'
                            ];
                        @endphp
