 <form class="filter-form" id="mainFilterForm" method="GET" action="{{ route('shop.index') }}">
                        ...
                        @php
                            $types = [
                                ...
                                'Заглушка', 'Старт-сендвіч', 'Труба-подовжувач', 'Прохід', 'Відображувач', 'Труба овальна', 'Трійник овальний 90°', 'Трійник овальний 45°', 'Коліно овальне 45°', 'Коліно овальне 90°', 'Закінчення димоходу овальне'
                            ];
                        @endphp
