        ...
        <select id="element_type" name="type" class="form-select" autocomplete="off">
            ...
            @php
                $types = [
                    ...
                    'Стіновий хомут', 'Монтажний хомут', 'Конус', 'Термоґрибok',
                    'Дека', 'Заглушка', 'Старт-сендвіч', 'Труба-подовжувач', 'Прохід', 'Відображувач', 'Трійник овальний 90°', 'Трійник овальний 45°', 'Коліно овальне 45°', 'Коліно овальне 90°',  'Закінчення димоходу овальне', 'Перехід овальний', 'Грибок овальний', 'Лійка овальна', 'Скоба овальна'
                ];
            @endphp
